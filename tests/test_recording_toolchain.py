...
from waclient.common_config import INTERNAL_CONTAINERS_DIR, INTERNAL_KEYS_DIR, get_encryption_conf
...
def test_nominal_recording_toolchain_case():
    ...
    toolchain = build_recording_toolchain(config, local_key_storage=local_key_storage, encryption_conf=encryption_conf)
